...
filtered_zips_2016 = [zip_code for zip_code in hospital_zips_2016 if
 zip_code.startswith(("70", "71", "72", "73", "74", "75", "76", "77", "78", "79"))]
...
```{python}
# just texas
texas_zip_codes_centroid = texas_zip_codes["geometry"].centroid
texas_zip_codes_centroid
```

there are 825 unique zipcodes texas

```{python}
# texas and surrounding area
texas_range = [i for i in range(70, 80)]
...
texas_and_surrounding_zip_codes_centroids = texas_and_surrounding_zip_codes["geometry"].centroid
```
